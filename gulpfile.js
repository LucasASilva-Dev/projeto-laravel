...
config.vendor_path_js = [
    ...
    config.bower_path + '/angular-http-auth/src/http-auth-interceptor.min.js'
...
gulp.task('default', ['clear-build-folder'], function () {
    gulp.start('copy-html','copy-images','copy-font');
    elixir(function(mix){
...
gulp.task('watch-dev', ['clear-build-folder'], function(){
 liveReload.listen();
 gulp.start('copy-styles','copy-scripts','copy-html','copy-images','copy-font');
