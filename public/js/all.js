...
app.run(['$rootScope', '$location', '$http', '$modal', '$cookies', '$pusher',
            ...
            if(OAuth.isAuthenticated()){
                if(!window.client){
                    ...
                    function(data) {
                        ...
                        Notification.success('Tarefa '+name+' foi includa!');
                    });
                }
            }
        }
...
/**
 * Created by Lucas on 11/11/2015.
 */
angular.module('app.directives')
...
/**
 * Created by Lucas on 16/11/2015.
 */
angular.module('app.directives')
